...
import { Send, MessageSquare, Search, Loader2, Plus, User, X, CheckCircle2, Trash2 } from "lucide-react";
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl space-y-4 animate-scale-up">
            ...
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search student or admin by name/email..."
                value={userQuery}
              ...
              {searchingUsers ? (
                ...
                userResults.map((u) => (
                  ...
                  >
                    ...
                    <span className={`text-[10px] px-2 py-0.5 rounded font-semibold ${u.role === "ADMIN" ? "bg-purple-100 text-purple-700" : "bg-emerald-100 text-emerald-700"}`}>
                      {u.role}
                    </span>
                  </button>
                ))
                  ...
                  >
                    <div>
                      <div className="font-poppins font-semibold text-sm text-gray-900 flex items-center gap-1.5">
                        ...
                        <span className={`text-[10px] px-1.5 py-0.5 rounded font-medium ${recipient?.role === "ADMIN" ? "bg-purple-100 text-purple-700" : "bg-emerald-100 text-emerald-700"}`}>
                          {recipient?.role || "USER"}
                        </span>
                      </div>
              ...
              <div className="p-4 bg-white border-b border-gray-100 flex items-center justify-between shadow-sm">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">{otherUser.email} · <span className="text-emerald-600 font-medium">Real-time Connected</span></div>
                  </div>
                </div>
                <button
                        ...
                        <div
                          className={`max-w-xs sm:max-w-md rounded-2xl p-3.5 text-sm shadow-sm ${
                            isMe
                              ...
                              : "bg-white border border-gray-200 text-gray-900 rounded-bl-none mr-auto"
                          }`}
                        >
                          {!isMe && (

...
import { Building2, ShieldCheck, User, Calendar, Receipt, Home } from "lucide-react";
...
export default async function BookingPayPage({ params }: PageProps) {
  ...
  if (!session?.user?.id) {
    redirect(`/auth/login?callbackUrl=/partner/bookings/${id}/pay`);
  }
  ...
  // Authorization check: Student, Admin, or Partner Owner can access this page
    ...
    return (
      <div className="max-w-md mx-auto py-16 px-4 text-center space-y-4">
        ...
        <p className="text-xs text-gray-500">
          This booking is assigned to another student account ({booking.student.email}). Please log in with the correct
          account.
        </p>
  ...
  return (
    <div className="min-h-[80vh] py-10 px-4 bg-gray-50/50">
      <div className="max-w-xl mx-auto space-y-6 animate-fade-in">
        ...
        {/* Interactive Pay Button Component */}
        <PayButton
        ...
        {/* Past Transactions for this booking */}
